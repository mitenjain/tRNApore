...
def main(myCommandLine=None):
    ...
    kmer_current_dict_trnaT6bA21 = kmer_current_map(os.path.join(modelPath, \
                                                             'trnaT6bA21_current_map.txt'))
    kmer_current_dict_trnaT6bA22 = kmer_current_map(os.path.join(modelPath, \
                                                             'trnaT6bA22_current_map.txt'))

    '''
    Construct models: trnaT2, trnaT3, trnaT4
    '''
    trnaT6bA21_model = model_maker( kmer_current_dict_trnaT6bA21, model_name = 'trnaT6bA21' )
    trnaT6bA22_model = model_maker( kmer_current_dict_trnaT6bA22, model_name = 'trnaT6bA22' )

    models = [ trnaT6bA21_model, trnaT6bA22_model ]
...
#    models[0].write(sys.stdout)
    ...
    matrix = {'T6bA21':{}, 'T6bA22':{}}
    matrix['T6bA21'] = {0:0, 1:0} 
    matrix['T6bA22'] = {0:0, 1:0} 
