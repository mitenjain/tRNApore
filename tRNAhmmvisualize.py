...
'trnaAbfFiles/t2_15n30003-s06.abf', #T2
#'trnaAbfFiles/t3_15d03003-s06.abf', #T3
#'trnaAbfFiles/t3_15d03004-s06.abf'
#'trnaAbfFiles/t3_15d08002-s06.abf'
#'trnaAbfFiles/t4_15d07002-s06.abf'  #T4
...
NormalDistribution(96.0, 12.0), NormalDistribution(85, 8), NormalDistribution(45, 5), NormalDistribution(36.0, 2.)]

boardlist2 = [polyDTboard, intermediateboard, intermediateboard2, abasictRNABoard, abasictRNABoard2, tRNABoard, tRNABoard1]
...
for file in it.imap( File, filenames ):
    ...
    rules = [lambda event: event.min > -5,
             lambda event: event.duration > 800000,
    ...
    for event in file.events:
        ...
        event.parse( SpeedyStatSplit( min_width=250, max_width=5000000, window_width=2000, min_gain_per_sample = 0.6))
